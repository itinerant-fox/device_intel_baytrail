 ...
 * AML/ASL+ Disassembler version 20150204-32 [Feb  4 2015]
 * Copyright (c) 2000 - 2015 Intel Corporation
 * 
 * Disassembling to symbolic ASL+ operators
 *
 * Disassembly of dsdt.dat, Fri Mar 13 11:15:00 2015
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00011AC5 (72389)
 *     Revision         0x02
 *     Checksum         0xD1
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I"
...
DefinitionBlock ("dsdt.aml", "DSDT", 2, "ALASKA", "A M I", 0x00000003)
{
    ...
    Name (ACPH, 0xDE)
    Name (FTBL, 0x04)
    OperationRegion (GNVS, SystemMemory, 0x7C020A90, 0x0337)
    ...
    OperationRegion (GPB2, SystemMemory, 0xFED0E248, 0x04)
    ...
    Scope (_SB)
    {
        ...
        Device (URT1)
        {
            ...
            Device (BTH2)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (UBUF) /* \_SB_.URT1.BTH2._CRS.UBUF */
                }
        ...
        Device (I2C1)
        {
            ...
            Device (CAM0)
            {
                ...
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    Return (PLDB) /* \_SB_.I2C1.CAM0.PLDB */
                }
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (SBUF) /* \_SB_.I2C1.CAM0._CRS.SBUF */
                }
            ...
            Device (CAMA)
            {
                ...
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    Return (PLDB) /* \_SB_.I2C1.CAMA.PLDB */
                }
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (SBUF) /* \_SB_.I2C1.CAMA._CRS.SBUF */
                }
            ...
            Device (CAME)
            {
                ...
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    Return (PLDB) /* \_SB_.I2C1.CAME.PLDB */
                }
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (SBUF) /* \_SB_.I2C1.CAME._CRS.SBUF */
                }
            ...
            Device (CAM2)
            {
                ...
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    Return (PLDB) /* \_SB_.I2C1.CAM2.PLDB */
                }
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (SBUF) /* \_SB_.I2C1.CAM2._CRS.SBUF */
                }
            ...
            Device (CAM7)
            {
                ...
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    Return (PLDB) /* \_SB_.I2C1.CAM7.PLDB */
                }
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (SBUF) /* \_SB_.I2C1.CAM7._CRS.SBUF */
                }
        ...
        Device (I2C2)
        {
                                ...
                                While (One)
                                {
                                    ...
                                    Else
                                    {
                                        If ((_T_1 == 0x04))
                                        {
                                            Return (Buffer (0x4C)
                                            {
                                                /* 0000 */  0x09, 0x00, 0x00, 0xCE, 0x40, 0x00, 0x01, 0x00,  /* ....@... */
                                                /* 0008 */  0x01, 0x00, 0x00, 0x00, 0x45, 0x00, 0x01, 0x00,  /* ....E... */
                                                /* 0010 */  0x01, 0x00, 0x00, 0x00, 0x46, 0x00, 0x01, 0x00,  /* ....F... */
                                                /* 0018 */  0x02, 0x00, 0x00, 0x00, 0x4B, 0x00, 0x01, 0x00,  /* ....K... */
                                                /* 0020 */  0x01, 0x00, 0x00, 0x00, 0x1D, 0x00, 0x01, 0x00,  /* ........ */
                                                /* 0028 */  0x03, 0x40, 0xBB, 0x00, 0x1D, 0x00, 0x01, 0x00,  /* .@...... */
                                                /* 0030 */  0x00, 0x04, 0x0D, 0x00, 0x1D, 0x00, 0x01, 0x00,  /* ........ */
                                                /* 0038 */  0xAF, 0xAF, 0x19, 0x00, 0x1D, 0x00, 0x01, 0x00,  /* ........ */
                                                /* 0040 */  0x8C, 0x8C, 0x02, 0x00, 0x1D, 0x00, 0x01, 0x00,  /* ........ */
                                                /* 0048 */  0xAA, 0xAA, 0x14, 0x01                           /* .... */
                                            })
                                        }
                                        Else
                                        {
                                            If ((_T_1 == 0x02))
                                            {
                                                Return (Buffer (0xF6)
                                                {
                                                    ...
                                                    /* 0058 */  0x00, 0x00, 0x01, 0x00, 0xAE, 0x00, 0xF8, 0x1D,  /* ........ */
                                                    ...
                                                    /* 0088 */  0x20, 0x01, 0x00, 0x00, 0xB0, 0x00, 0x00, 0x60,  /*  ......` */
                                            ...
                                            Else
                                            {
                                                If ((_T_1 == 0x03))
                                                {
                                                    Return (Buffer (0x42)
                                                    {
                                                        ...
                                                        /* 0010 */  0xE4, 0x21, 0x00, 0x00, 0xB6, 0x00, 0x80, 0x01,  /* .!...... */
            ...
            Device (CAM9)
            {
                ...
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    Return (PLDB) /* \_SB_.I2C2.CAM9.PLDB */
                }
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (SBUF) /* \_SB_.I2C2.CAM9._CRS.SBUF */
                }
            ...
            Device (CAMB)
            {
                ...
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    Return (PLDB) /* \_SB_.I2C2.CAMB.PLDB */
                }
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (SBUF) /* \_SB_.I2C2.CAMB._CRS.SBUF */
                }
            ...
            Device (CAMC)
            {
                ...
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    Return (PLDB) /* \_SB_.I2C2.CAMC.PLDB */
                }
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (SBUF) /* \_SB_.I2C2.CAMC._CRS.SBUF */
                }
            ...
            Device (CAMD)
            {
                ...
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    Return (PLDB) /* \_SB_.I2C2.CAMD.PLDB */
                }
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (SBUF) /* \_SB_.I2C2.CAMD._CRS.SBUF */
                }
            ...
            Device (CAMF)
            {
                ...
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    Return (PLDB) /* \_SB_.I2C2.CAMF.PLDB */
                }
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (SBUF) /* \_SB_.I2C2.CAMF._CRS.SBUF */
                }
            ...
            Device (CAM8)
            {
                ...
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    Return (PLDB) /* \_SB_.I2C2.CAM8.PLDB */
                }
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (SBUF) /* \_SB_.I2C2.CAM8._CRS.SBUF */
                }
            ...
            Device (TCS4)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (RBUF) /* \_SB_.I2C2.TCS4._CRS.RBUF */
                }
            ...
            Device (TCS3)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (RBUF) /* \_SB_.I2C2.TCS3._CRS.RBUF */
                }

                Method (_STA, 0, NotSerialized)  // _STA: Status
                {
                    If (((OSSL == 0x02) || (OSSL == 0x03)))
                    {
                        Return (0x0F)
                    }
        ...
        Device (I2C3)
        {
            ...
            Device (SALS)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    If ((OSSL & 0x80))
                    {
                        Return (ABUF) /* \_SB_.I2C3.SALS._CRS.ABUF */
                    }
                    Else
                    {
            ...
            Device (SPA1)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (RBUF) /* \_SB_.I2C3.SPA1._CRS.RBUF */
                }
            }
            ...
            Device (SPB1)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (RBUF) /* \_SB_.I2C3.SPB1._CRS.RBUF */
                }
            }
            ...
            Device (SPB2)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (RBUF) /* \_SB_.I2C3.SPB2._CRS.RBUF */
                }
            }
            ...
            Device (SPG1)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (RBUF) /* \_SB_.I2C3.SPG1._CRS.RBUF */
                }
            }
            ...
            Device (SAR2)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (RBUF) /* \_SB_.I2C3.SAR2._CRS.RBUF */
                }
            }
        ...
        Device (I2C4)
        {
            ...
            Device (TCS3)
            {
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (RBUF) /* \_SB_.I2C4.TCS3._CRS.RBUF */
                }
            ...
            Device (TCS6)
            {
                ...
                Name (_CID, "PNP0C50" /* HID Protocol Device (I2C bus) */)  // _CID: Compatible ID
                Name (_SUB, "NTRG1B96")  // _SUB: Subsystem ID
                Name (_S0W, Zero)  // _S0W: S0 Device Wake State
                Name (_DDN, "NTRG1B96")  // _DDN: DOS Device Name
                Name (_DEP, Package (0x02)  // _DEP: Dependencies
                {
                    GPO1, 
                    I2C5
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    Return (RBUF) /* \_SB_.I2C4.TCS6._CRS.RBUF */
                }
    ...
    Scope (_SB.I2C5)
    {
        ...
        Device (BMBT)
        {
            ...
            CreateByteField (BUF2, One, SLEN)
            CreateWordField (BUF2, 0x02, WRD1)
            Name (BUF9, Buffer (0x03)
            {
                 0x00, 0x01, 0x00                                 /* ... */
            })
            CreateByteField (BUF9, Zero, BU9S)
            CreateByteField (BUF9, 0x02, BU9D)
            Name (BIXP, Package (0x14)
            {
                Zero, 
                One, 
            ...
            Method (_BIX, 0, NotSerialized)  // _BIX: Battery Information Extended
            {
                ...
                If ((^^BMDR.AVBL == One))
                {
                    Index (BIXP, 0x03) = MAXM /* \_SB_.I2C5.BMBT.MAXM */
            ...
            Method (_BST, 0, Serialized)  // _BST: Battery Status
            {
                ...
                If ((^^BMDR.AVBL == One))
                {
                    ...
                    If ((MHST != One))
                    {
                        ...
                        {
                            MHDT &= 0x7F
                            MANX = (MAXM * MHDT) /* \_SB_.I2C5.BMBT.MHDT */
                    ...
                    Else
                    {
                        ...
                        If ((MHDT != 0x64))
                        {
                            BUF9 = XP33 /* \_SB_.I2C5.XP33 */
                            BU9D |= 0x80
                            XP33 = BUF9 /* \_SB_.I2C5.BMBT.BUF9 */
                            While (One)
                            {
                                _T_0 = MHDT /* \_SB_.I2C5.BMBT.MHDT */
                                If ((_T_0 == 0x63))
                                {
                                    If ((MIDT == 0x40))
                                    {
